...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        /*echo dirname($this->get_server_var('SCRIPT_FILENAME')).str_replace("REPLACE","/",$_REQUEST['upload_path'])."/";
        echo '<br>';
        echo $this->get_full_url().'/'.str_replace("REPLACE","/",$_REQUEST['upload_path']);
        die;*/
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/'.str_replace("REPLACE","/",$_REQUEST['upload_path']),
            'upload_url' => $this->get_full_url().'/'.str_replace("REPLACE","/",$_REQUEST['upload_path']),
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
         ...
         //$name = str_remplace(" ","-",$name);
        $file = new stdClass();
        $file->name = $this->get_file_name($name, $type, $index, $content_range);
        //$file->name = str_remplace(" ","-",$file->name);
