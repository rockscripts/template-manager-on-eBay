(function () {
        ...
        j.list = {
            listToArray: function (L, M, N, O, P) {
                ...
                for (var Q = 0, R = L.getChildCount(); Q < R; Q++) {
                    ...
                    } else T.grandparent = P; if (M) h.setMarker(M, S, 'listarray_index', N.length);
                    N.push(T);
    ...
    (function () {
        ...
        function q(C) {
            ...
            } else L.document.$.execCommand('inserthtml', false, C); if (b.webkit) {
                D = L.getSelection();
                D.scrollIntoView();
            }
        };
                    ...
                    C.addMode('wysiwyg', {
                        ...
                        loadData: function (W) {
                            ...
                            if (Y) {
                                ...
                                W = Z + W;
                            } else W = X.docType + '<html dir="' + X.contentsLangDirection + '"' + ' lang="' + (X.contentsLanguage || C.langCode) + '">' + '<head>' + '<title>' + E + '</title>' + ab + aa + '</head>' + '<body' + (X.bodyId ? ' id="' + X.bodyId + '"' : '') + (X.bodyClass ? ' class="' + X.bodyClass + '"' : '') + '>' + W + '</html>'; if (b.gecko) W = W.replace(/<br \/>(?=\s*<\/(:?html|body)>)/, '$&<br type="_moz" />');
                            W += U;
                            this.onDispose();
                            T(W);
                        },
    ...
    (function () {
        ...
        a.dialog = function (S, T) {
            ...
            if (S._.removeDialogTabs && (Y = S._.removeDialogTabs[T]))
                for (Z = 0; Z < Y.length; Z++) U.removeContents(Y[Z]);
        ...
        a.dialog.prototype = {
            ...
            show: function () {
                ...
                else S.setStyle('display', 'block'); if (b.gecko && b.version < 10900) {
        ...
        function A(S) {
            ...
            function Z(ab) {
                ...
                else ai = U.x; if (U.y + Y[0] < X) aj = -Y[0];
                    ...
                    var X = this._.children = T,
                        ...
                        aa = {}, ab, ac = function () {
                            ...
                            for (ab = 0; ab < U.length; ab++) {
                                ...
                                } else ag.push('width:' + Math.floor(100 / U.length) + '%'); if (Z) ag.push('height:' + m(Z));
