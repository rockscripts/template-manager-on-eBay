...
var store_name = "Bridgewater-Antiques";
var store_id = "euro-lex";
var store_url = "http://stores.ebay.co.uk/bridgewaterantiques";
var store_phone = "";
var currency = "GBP";
var hosting_url = "http://hosting.rockscripts.org/76";
var site_domain = "";
...
document.write('<a href="" class="store-home-url"><img class="logo store-home-url" src="http://fileshosting.rockscripts.org/files/store_design/logos/76//rsz_worsley-coat_of_arms.png" /></a>');


var main_menu = '<ul class=\'nav navbar-nav\'>'+
'<li class="menu-item"><a href="http://feedback.ebay.co.uk/ws/eBayISAPI.dll?ViewFeedback2&userid=euro-lex&ftab=AllFeedback">Feedbacks</a></li>'+
'</ul>';


document.write('<img src="http://fileshosting.rockscripts.org/files/store_design/general_images/76//header-background-bridgewater-antiques.png"  class="img-responsive header-background-image">');


var  dynamic_categories = '<ul class=\'vertical blue\'>'+
'<li><a href="http://stores.ebay.co.uk/Bridgewater-Antiques/antique-furniture-/_i.html?_fsub=6832299014">Antique furniture</a>'+
'<ul>'+
'<li><a href="http://stores.ebay.co.uk/Bridgewater-Antiques/20th-century-/_i.html?_fsub=6832300014">20th century</a></li>'+
'</ul>'+
'</li>'+
'</ul>';
...
var left_widgets = ["popular categories","advertising"];
...
'<img alt="" src="http://fileshosting.rockscripts.org/files/upload/76/images/banner-4-238x115.png" /></div>'+
'<div class="left banner-center banner-central banner-secure">'+
'<img alt="" src="http://fileshosting.rockscripts.org/files/upload/76/images/banner-3-238x115.png" /></div>'+
'<div class="left banner-center banner-central banner-postage">'+
'</div>'+
'<div class="left banner-center banner-central banner-lowprice">'+
'<img alt="" src="http://fileshosting.rockscripts.org/files/upload/76/images/banner-1-238x115.png" /></div>'+
'</div>'+
'<div>'+
'</div>';


var twiter_url = "http://twiter.com";
...
var  front_advertisings = '<a href="http://pages.ebay.co.uk/paypal/for_buyers.html">'+
'<img src="http://fileshosting.rockscripts.org/files/store_design/home_design_advertisements/76//p12.png" title="Paypal" class="advertising-image">'+
'</a>';


var  popoular_categories = '<div class="rc-box">'+
'<div class="rc-image">'+
'<a title="Books - Law & Government" href="http://stores.ebay.co.uk/eurolex/Law-Government-/_i.html?_fsub=6554435014">'+
'<img src="http://fileshosting.rockscripts.org/files/store_design/popular_categories/76//lawbooks-2.jpg" alt="[NAME]"/>'+
'</a>'+
'</div>'+
'<div class="rc-name">'+
'<span>Books - Law & Government</span>'+
'</div>'+
'</div>';
...
'<li class="menu-item"><a href="http://feedback.ebay.co.uk/ws/eBayISAPI.dll?ViewFeedback2&userid=euro-lex&ftab=AllFeedback">Feedbacks</a></li>'+
'<li class="menu-item"><a href="http://contact.ebay.co.uk/ws/eBayISAPI.dll?FindAnswers&frm=284&requested=euro-lex&iid=-1">Contact Us</a></li>'+
'</ul>';
...
if(front_design_option_display_widgets_categories=="OFF")
    {
        ...
        jQuery(".layout-type-2 .vTitle").css("display","none");
        jQuery(".layout-type-2 .flexslider").css("display","none");
        jQuery(".layout-type-2 .Our-Listings").css("display","inline");
    }
}}
 });
