...
{ 
    ...
    function get_code_tagged_part($design, $element_key,$id_ebay_design,$id_design,$user_id)
        ...
        if($design == "front"):
            ...
            $sql_query  = "SELECT * FROM (`home_design_parts_tagged`) WHERE `id_ebay_design` = '$id_ebay_design' AND `id_home_design` = '$id_design' AND `id_user` = '$user_id' AND `element_key` = '$element_key'";
         ...
         public function exist_code_part ($design, $element_key,$id_ebay_design,$id_design,$user_id)
        {
            $result = $this->get_code_tagged_part($design, $element_key,$id_ebay_design,$id_design,$user_id);
            if(!$result):
                return false;
                else:
                    return true;
        ...
        public function create_home_part_tagged($design, $element_key,$id_ebay_design,$id_design,$user_id,$html_code_tagged)
        {
             if($design == "front"):
                 if(!$this->exist_code_part($design, $element_key,$id_ebay_design,$id_design,$user_id)):
                     $data = array
                    (
                    'html_code_tagged' => $html_code_tagged
                    );
                   $data_condition = array
                    ...
                    $this->db->update('home_design_parts_tagged', $data);   
                 endif;    
                 else:
                     $data = array
                    (
                   ...
                   $data_condition = array
                    ...
                    $this->db->where($data_condition);
                    $this->db->update('listing_design_parts_tagged', $data); 
             endif;          
        }
        
         public function update_home_part_tagged($element_key,$id_ebay_design,$id_design,$user_id,$html_code_tagged)
    {
    $data = array
            (
            'html_code_tagged' => $html_code_tagged
