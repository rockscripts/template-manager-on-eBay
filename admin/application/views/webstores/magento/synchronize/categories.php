...
<div class="webstire-install-step-1">
    <h4 class="widgettitle nomargin shadowed">Synchronize categories</h4>
          ...
          if(isset($categories_tree)):
              if(sizeof($categories_tree)>0):
                 //s echo "<pre>";
                  ...
                  ?>
   <a href="<?=base_url()?>/webstores/webstore/synchronize_categories" class="btn btn-primary install_webstoreandcategories " style="margin: 0 0 10px 10px;">
