...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        var url = window.location.hostname === 'blueimp.github.io' ?
                '//jquery-file-upload.appspot.com/' : 'http://'+window.location.hostname+'/upload.php?upload_path=serverREPLACEphpREPLACEfilesREPLACEstore_designREPLACEarrivalsREPLACE'+id_user+'/',
        ...
        jQuery('#fileupload').fileupload({
          ...
          /*  data:{id:"3"} ,*/
            ...
            jQuery.each(data.result.files, function (index, file) {
               ...
               save_new_arrivals_listing(id,title,link,price,file.url);   
