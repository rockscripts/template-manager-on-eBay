 ...
 <h4 class="widgettitle nomargin shadowed">Manage Store Front Template</h4>
<div class="widgetcontent bordered shadowed nopadding">  
    ...
    <div class="inner">
        <div class="banner  clear-both">
         ...
         <?php
         if(is_array($array_store_front_designs)):
   ...
   // foreach($array_listing_designs as $array_listing_design):
        foreach($array_store_front_designs as $listing_design):
          ?>
