...
<div class="alert2  alert-info">
              <i class="icon-info-sign"></i>Recommended image sizes: 990 x 290 pixels
  </div>

 <h4 class="widgettitle nomargin shadowed">Manage Header Background</h4>
...
{
  ?>
<img src="<?=base_url()?>/themes/katniss/img/header_home.png"  id="logo_design"/>
<?php  
}
?>
 <br>
    ...
    jQuery('#fileupload').fileupload({
      ...
      /*  data:{id:"3"} ,*/
        ...
        jQuery.each(data.result.files, function (index, file) {
            ...
            ajax_update_general_setting(file.url.replace("http://"+window.location.hostname+"/designmanager/server/php","http://fileshosting."+window.location.hostname),"header-background");          
            ...
            jQuery("#message_content").html("Header background was updated successful.");
