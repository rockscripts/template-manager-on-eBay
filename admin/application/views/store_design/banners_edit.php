 ...
 <h4 class="widgettitle nomargin shadowed">Manage Banner Design</h4>
...
{
    ?>
<img src="<?=$banner_url?>" id="logo_design" />
<input type="hidden" id="current_id_banner" value="<?=$id_banner?>"/>
<?php
...
{
  ?>
<img src="<?=base_url()?>/themes/katniss/img/coming_soon<?php echo (intval($_GET["id_design"]) > 1 ? "_1" : "");?>.png"  id="logo_design"/>
<?php  
}
?>
 <br>
...
function updateBannersURL(user_id,id_design,banner_url,base_url,action,id_banner)
  {
      jQuery.ajax
      ({
		 
      url: base_url+"/store_design/banners/"+action,
      async: false,
      type: "POST", 
       data:{"user_id":user_id,"id_design":id_design,"banner_url":banner_url,"id_banner":id_banner} ,    
      dataType: "json",
