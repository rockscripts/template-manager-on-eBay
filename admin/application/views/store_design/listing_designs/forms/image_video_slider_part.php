...
<h4 class="widgettitle nomargin shadowed">Save Image Slider</h4>
    ...
    <div class="widgetcontent bordered shadowed nopadding">
        ...
        <p class="stdformbutton">
            <div class="btn btn-primary" id="saven_images_videos_slider" style="margin-left: 15px;"><i class="iconsweets-zip"></i>Save</div>
        </p>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#saven_images_videos_slider").click(function()
        {
                ...
                if ( validate_link( link ) )
                {
                    ...
                    if(jQuery('#files').find('div').size() >0) {
                        ...
                        jQuery("#files").find("button").first().trigger('click');
                          ...
                          if(id > 0)
                            {
                            save_images_videos_slider(id,link,'ignore',"");
                            jQuery("li.listing-slider").click() ;
                            jQuery(".listing-images").css("display","none");
                           show_successfull_message("Image was saved successful");
                    }
