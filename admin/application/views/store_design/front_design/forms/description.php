<div class="description-form-content">
    ...
    <div class="widgetcontent bordered shadowed nopadding">
        ...
        <p>
                ...
                <!-- <textarea name="description"><?=$listing_description->description ?></textarea> -->
                <?php 
            		$config_mini = array();   
            		...
            		echo $this->ckeditor->editor("description", html_entity_decode($listing_description->description) , $config_mini);
                        else
