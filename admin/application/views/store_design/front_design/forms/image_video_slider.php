        ...
        <div class=" banner" >
            ...
            <div class="listing-advertising-box featured-box custom-width" style="height: 188px;">
                ...
                if($array_images[$index_image] ['link']!=""):
                    ?>
                 <a href="<?=$array_images[$index_image] ['link']?>" target="_blank" ><img src="<?=$array_images[$index_image] ['image_url']?>" id="img-<?=$array_images[$index_image] ['id_home_design_slider'] ?>"></a>
                <?php
                    else:
                    ?>
                 <img src="<?=$array_images[$index_image] ['image_url']?>" style="width: 100%;height:134px" id="img-<?=$array_images[$index_image] ['id_home_design_slider'] ?>">
                <?php
                endif;
                ?>
                ...
                <div class="more clr">
                        <div class="box-controls">
                            ...
                            <div action="delete" id_home_design_slider="<?=$array_images[$index_image] ['id_home_design_slider'] ?>" title="Delete  Image" class="button-controls custom_button" >
                                 <i class="icon-trash"  title="Delete  Image"></i>
                            </div>
                            
                            <span class="separator-left">&nbsp;|&nbsp;</span>

                            <div action="edit" id_home_design_slider="<?=$array_images[$index_image] ['id_home_design_slider'] ?>" title="Edit  Image" class="button-controls custom_button" >
              ...
              <iframe width="100%" height="auto" src="//www.youtube.com/embed/<?=$video_id?>" frameborder="0" allowfullscreen></iframe>
                ...
                <div class="more clr">
                        <div class="box-controls">
                            ...
                            <div action="delete" id_home_design_slider="<?=$array_videos[$index_video] ['id_home_design_slider'] ?>" title="Delete Video" class="button-controls custom_button" >
                                 <i class="icon-trash"  title="Delete Video"></i>
                            </div>
                            
                            <span class="separator-left">&nbsp;|&nbsp;</span>

                            <div action="edit1" id_home_design_slider="<?=$array_videos[$index_video] ['id_home_design_slider'] ?>" title="Edit Video" class="button-controls custom_button" provider="<?= ucwords(strtolower($array_videos[$index_video] ['type']) )?>">
...
jQuery(document).ready(function() {
    ...
    jQuery(".button_new_image_video_slider").click(function()
    {
        ...
        jQuery(".advertising-form-content").html( ajax_load_images_videos_slider_part_form() ) ;
    ...
    jQuery(".custom_button").click(function()
    {
      ...
      if(action=="delete")
      {
        id_home_design_slider = jQuery(this).attr("id_home_design_slider");
        var result = confirm("Are you sure?");
        if (result==true) 
        {
            message =  delete_home_design_images_videos_slider(id_home_design_slider);   
            show_successfull_message(message);
            var current_src = jQuery("#img-"+id_home_design_slider).attr("src");
        ...
        if(action=="edit")
        {
          ...
          jQuery(".button_new_image_video_slider_yt").fadeOut();
          jQuery(".button_new_image_video_slider_vimeo").fadeOut();
          id = jQuery(this).attr("id_home_design_slider"); 
          images_videos_slider = load_home_design_images_videos_slider_array(id)
          jQuery(".advertising-form-content").html( ajax_load_images_videos_slider_part_form()  );

          jQuery('#id').val(images_videos_slider[0].id_home_design_slider);
          ...
          if(action=="edit1")
        {
         jQuery(".button_back_advertising").fadeIn();
          ...
          jQuery(".advertising-form-content").html( ajax_load_home_design_images_videos_slider_part_providers_form(provider)  );
/*
 * 
 ...
 */
        ...
        {
        jQuery(".alert").css("display","none");
        jQuery(".advertising-form-content").html( ajax_load_home_design_images_videos_slider_part_providers_form('Youtube') ) ;
        jQuery(".advertising-form-content").fadeIn();
        jQuery(".listing-advertising").fadeOut();
       jQuery(this).fadeOut();
        jQuery(".button_new_image_video_slider").fadeOut();
        ...
        {
        jQuery(".alert").css("display","none");
        jQuery(".advertising-form-content").html( ajax_load_home_design_images_videos_slider_part_providers_form('Vimeo') ) ;
        jQuery(".advertising-form-content").fadeIn();
        jQuery(".listing-advertising").fadeOut();
         jQuery(this).fadeOut();
        jQuery(".button_new_image_video_slider").fadeOut();
