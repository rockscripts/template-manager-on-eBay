...
print form_open('membership/forgot_username/send_username', array('id' => 'username_form', 'class' => 'membership_form')) ."\r\n";
?>
...
<h2><?php print $this->lang->line('forgot_username'); ?></h2>
...
<div>
<?php print form_submit(array('name' => 'forgot_username_submit', 'value' => $this->lang->line('send_username'), 'id' => 'forgot_username_submit', 'class' => 'membership_submit')); ?></div>
