...
<div class="text_black"><?php print $this->lang->line('current_email'); ?>: <strong><?php print $email; ?></strong></div>
...
print form_open('private/profile/update_password', array('id' => 'profile_pwd_form', 'class' => 'membership_form')) ."\r\n";
?>
<div class="membership_box">
    <div id="pwd_error">
        <?php
...
<div class="text_black"><?php print $this->lang->line('send_copy_to_email') . form_checkbox('send_copy', 'accept', TRUE); ?></div>
<div>
<?php print form_submit(array('name' => 'submit', 'value' => $this->lang->line('update_password'), 'id' => 'profile_pwd_submit', 'class' => 'membership_submit')); ?></div>
<?php print form_close() ."\r\n";