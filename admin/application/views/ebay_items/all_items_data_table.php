 <table class="table table-bordered items_data_table all_items_data_table" id="dyntable_resultados" >
  <thead>
      <tr>
          <th class="head0 sorting"><div class="checker item_check_all" data="all_items_data_table"><input type="checkbox"  name="check2" style="opacity: 0;"></div></th>
        ...
        <tr>
            <td style="width:6px!important;">
                ...
                if($item->ListingStatus == "Active"):
                    ?>
                <div class="active-label" title="Active | Go to Active items to do an action with"></div>
                <?php
