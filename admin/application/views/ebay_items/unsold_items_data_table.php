 <table class="table table-bordered items_data_table unsold_items_data_table" id="dyntable_resultados4" >
  <thead>
      <tr>
          <th class="head0 sorting"><div class="checker item_check_all" data="unsold_items_data_table"><input type="checkbox"  name="check2" style="opacity: 0;"></div></th>
...
<script>
    ...
    jQuery('#dyntable_resultados4').dataTable({
