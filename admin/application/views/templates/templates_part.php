    <h4 class="widgettitle nomargin shadowed">Save Suggested template</h4>
          ...
          if(title != "")
            {   
                if (  validate_link( link ) )
                {
                    ...
                    {                        
                         jQuery(".loader-image").fadeIn();
                         save_suggested_template(id,title,link,'ignore');     
                         show_successfull_message("template saved"); 
                         remove_error_field("name");
                         remove_error_field("link");
                    }
                    else
                    {   show_error_message("Please select template image.") ;}
                     
                    }
                } else {
                   show_error_message("Template link is invalid.") ;
                   jQuery("#link").css("border","1px  solid red")    ;   
                }
            } else {
                show_error_message("Template name is empty.") ;
