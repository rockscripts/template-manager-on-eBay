...
jQuery(function($)
{
 ...
 {
     $(".v4sem").append(' | <a class="powered_link" href="http://rockscripts.us" >Powered by: <img src="http://hosting.rockscripts.us/default/images/rockscripts-small.png" class="rockscripts-logo-small"></a>');
    ...
    body_width = $("body").width();
     switch(layout_type)
     {
      case 1:
         ...
         /*buld central area*/
        show_number_of_listings_requested();
...
function show_number_of_listings_requested()
{
