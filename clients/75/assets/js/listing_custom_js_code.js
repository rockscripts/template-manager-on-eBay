...
jQuery(document).ready(function()
{
  ...
  if(body_width<=360)
  {
   jQuery("img.logo").css("left","0%");
    jQuery(".Store-categories").css("display","block");
    jQuery(".Store-categories-title").css("display","block");
    jQuery(".navbar-inverse .nav > li").css("border-right","0px solid");
    jQuery(".navbar-collapse").css("background","black");
    jQuery(".navbar-nav").css("width","100%");
